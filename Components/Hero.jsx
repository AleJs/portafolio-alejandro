    ...
    <section className="hero">
      <HeroBox className="hero-box">
        <div className="hero-box_text">
          <div className="text">
            <h1 className="luis active">
              Alejandro <br />
              Ramirez
            </h1>
            <h1 className="luis active2">
              Alejandro Ramirez
            </h1>
            <p>
          ...
          <Button to={"/portafolio-alejandro/works/web"}>
            <span class="button-50" role="button">
              Portafolio{" "}
            </span>
          </Button>
        </div>
        ...
        <ContainerPhoto className="hero-box_photo">
          ...
          <div className="iconsvgSociall">
            <a
              href="https://www.linkedin.com/in/alejandro-ramirez-11080a143/        
            "
            >
              <motion.svg
                className="svg"
                whileTap={{ scale: 0.9 }}
                whileHover={{ rotate: [0, 5, 0], scale: 1.1 }}
                width="82"
                height="80"
                viewBox="0 0 82 80"
                fill="none"
              ...
              >
                ...
                />
                <path
                  d="M54.9286 15H18.0618C16.3725 15 15 16.3594 15 18.0281V53.9719C15 55.6406 16.3725 57 18.0618 57H54.9286C56.6179 57 58 55.6406 58 53.9719V18.0281C58 16.3594 56.6179 15 54.9286 15ZM27.996 51H21.6228V30.9562H28.0056V51H27.996ZM24.8094 28.2188C22.765 28.2188 21.1141 26.5969 21.1141 24.6094C21.1141 22.6219 22.765 21 24.8094 21C26.8442 21 28.5047 22.6219 28.5047 24.6094C28.5047 26.6062 26.8538 28.2188 24.8094 28.2188V28.2188ZM51.8859 51H45.5127V41.25C45.5127 38.925 45.4647 35.9344 42.2013 35.9344C38.8804 35.9344 38.3717 38.4656 38.3717 41.0813V51H31.9984V30.9562H38.1125V33.6937H38.1989C39.0531 32.1187 41.1359 30.4594 44.2362 30.4594C50.6862 30.4594 51.8859 34.6125 51.8859 40.0125V51V51Z"
                  fill="black"
                />
              </motion.svg>
            </a>
